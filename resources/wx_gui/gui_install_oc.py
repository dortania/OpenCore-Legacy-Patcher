...
class InstallOCFrame(wx.Frame):
    ...
    def _display_disks(self) -> None:
        ...
        gpt_note.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, self.constants.apple_font))
        ...
        if self.available_disks:
            ...
            if disk_root:
                ...
                disk_label.SetFont(wx.Font(10, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, self.constants.apple_font))
            ...
            disk_label.SetFont(wx.Font(13, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, self.constants.apple_font))
            disk_label.Centre(wx.HORIZONTAL)
    ...
    def _display_volumes(self, disk: str, dataset: dict) -> None:
        ...
        text_label.SetFont(wx.Font(19, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, False, self.constants.apple_font))
        text_label.Centre(wx.HORIZONTAL)

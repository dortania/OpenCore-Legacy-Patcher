...
::: warning 3GB+ RAM required for macOS Sonoma installers and macOS Sequoia
Models with 2GB RAM will not be able to install macOS Sonoma and macOS Sequoia will be unable to boot. macOS Sonoma may be installed using a disk swap method where installation is done on another system but your mileage may vary and this is not recommended.
:::

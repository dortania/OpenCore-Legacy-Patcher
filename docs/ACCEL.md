...
There are two ways around it, you can either use tccplus to grant permissions (found in the workaround dropdown) or try a new AMFIPass beta build found in the Discord server.
